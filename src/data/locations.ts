...
export const LOCATIONS: Location[] = [
    ...
    { id: 'club_ribera', zoneId: 'la_ribera', nombre: 'Club Social y Deportivo La Ribera', descripcion: 'Un club de barrio sospechosamente bien equipado para lo que dice ser.', npcIds: [] },
    ...
    { id: 'anden_4', zoneId: 'terminal_norte', nombre: 'Andén 4 — Terminal Norte', descripcion: 'Trenes que llegan cuando quieren. El lugar preferido de los que "vieron algo".', npcIds: ['nazareno_quiroga'] },
    ...
    { id: 'delegacion_villa_quieta', zoneId: 'villa_quieta', nombre: 'Delegación Municipal de Villa Quieta', descripcion: 'Todos están tomando mate. Ningún trámite avanza nunca.', npcIds: ['marta_yulis', 'walter_chiodi'] },
    ...
    { id: 'estacion_fantasma', zoneId: 'el_cruce', nombre: 'Estación Fantasma de El Cruce', descripcion: 'Andén abandonado, usado como punto de entrega de cosas que no deberían entregarse.', npcIds: ['media_cuadra_ibanez'] },
